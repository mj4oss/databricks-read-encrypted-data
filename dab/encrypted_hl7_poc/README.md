...
The 'encrypted_hl7_poc' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/encrypted_hl7_poc/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] encrypted_hl7_poc_etl` to your workspace.
